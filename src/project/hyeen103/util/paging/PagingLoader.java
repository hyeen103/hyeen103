 ...
 *				: [20231201124812][pluto@himedia.co.kr][CREATE: Initial Release]
 */
package project.hyeen103.util.paging;
...
import project.hyeen103.util.Xml;
		...
		try {
			...
			for (int index = 0; index < nodeList.getLength(); index++) {
				...
				if (styleId != null) {
					...
					pageNavInfo.setContainerOpen(project.hyeen103.util.Xml.getNodeValue(XPathAPI.selectSingleNode(document, "/pageNavigator/style[@id='" + styleId + "']/containers/container[@name='containerOpen']/text()")));
